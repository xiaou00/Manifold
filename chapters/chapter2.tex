...
展开定义得
\[\frac{\del}{\del\phi^i}\Big|_p(g\circ f)=\sum_{j=1}^n{\frac{\del(g\circ f\circ\phi^{-1})^j}{\del x^i}\Big|_{\phi(p)}}\]
由链式法则, 上式等价于
\[\sum_{j=1}^n{\frac{\del g}{\del x^i}\Big|_{f(p)}\cdot\frac{\del(f\circ\phi^{-1})^j}{\del x^i}\Big|_{\phi(p)}}\]